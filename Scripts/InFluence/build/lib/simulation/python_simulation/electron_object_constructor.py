...
class ElectronEvolver:
    ...
    def __init__(self, E_i, ProbeDiameter, Density):
        ...
        self.InitialPosition = initialise_postions(self.step, self.ProbeDiameter)     
