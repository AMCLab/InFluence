from simulation.cpp_simulation import InFluence
...
def CPP_MCScatteringSimulation(pixels,
    ...
    perfect_image_0, perfect_image_1, Density, t_counting, AlphaMultiplier, CrossSectionNumorator, CrossSectionLogArgMultiplier, CrossSectionDenominatorA, CrossSectionDenominatorB, PathLengthMultiplier, EnergyLossMultiplierA, EnergyLossMultiplierB)
