...
class image_pixels:
    original_image = None
    perfect_image = None
    electron_dose = params.dose
    pixels = None                                   # This is a list of pixel objects
    ...
    def find_distribution(self):
        ...
        selected_indices = np.random.choice(len(self.pixels), size=params.dose, p=probabilities)
