...
std::vector<double> evaluate_direction_cosine_a(const std::vector<double>& phis, const std::vector<double>& psis, const std::vector<double>& cosineYs, const std::vector<double>& cosineZs);

double evaluate_direction_cosine_b(double phi, double psi, double cosineX, double cosineY, double cosineZ);

std::vector<double> evaluate_direction_cosine_b(const std::vector<double>& phis, const std::vector<double>& psis, const std::vector<double>& cosineXs, const std::vector<double>& cosineYs, const std::vector<double>& cosineZs);

double evaluate_direction_cosine_c(double phi, double psi, double cosineZ);

std::vector<double> evaluate_direction_cosine_c(const std::vector<double>& phis, const std::vector<double>& psis, const std::vector<double>& cosineZs);

double evaluate_energy_loss_rate(double E, double EnergyLossMultiplierA, double EnergyLossMultiplier);

std::vector<double> evaluate_energy_loss_rate(const std::vector<double>& energies, double EnergyLossMultiplierA, double EnergyLossMultiplier);
