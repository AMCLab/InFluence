...
def PlotTrajectories(vector_coordinates_x, vector_coordinates_y, vector_coordinates_z, points_per_trajectory):
    ...
    plt.savefig('/workspaces/InFluence/Scripts/InFluence/MonteCarloScatteringSimulation_Python_Files/', dpi = 300,transparent = True, bbox_inches = 'tight', pad_inches = 0)
    plt.savefig('/workspaces/InFluence/Scripts/InFluence/MonteCarloScatteringSimulation_Python_Files/', dpi=300, transparent=True, bbox_inches='tight', pad_inches=0)
